namespace MessageRouter.FSharp

open System
open MessageRouter.FSharp.ReflectionHelper

// This is a wrapper for C# to call without having to deal with creating a Discriminated Union of Type
